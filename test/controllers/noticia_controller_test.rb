...
class NoticiaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create noticium" do
    assert_difference('Noticium.count') do
      post noticia_url, params: { noticium: { bajada: @noticium.bajada, cuerpo: @noticium.cuerpo, fecha: @noticium.fecha, hora: @noticium.hora, titulo: @noticium.titulo } }
    end
  ...
  test "should update noticium" do
    patch noticium_url(@noticium), params: { noticium: { bajada: @noticium.bajada, cuerpo: @noticium.cuerpo, fecha: @noticium.fecha, hora: @noticium.hora, titulo: @noticium.titulo } }
